...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { ListUserPostsController } from './../controllers/listUserPostController/ListUserPostController';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
const models: TsoaRoute.Models = {
  ...
  IPost: {
    ...
    properties: {
      ...
      postOwnerUserName: { dataType: 'string', required: true },
      category: {
        dataType: 'array',
        array: { dataType: 'string' },
        required: true,
      },
      postOwner: { ref: 'IUserModel' },
      created_at: { dataType: 'datetime' },
      updated_at: { dataType: 'datetime' },
    },
    additionalProperties: false,
  ...
  ICreateSessionResponseDTO: {
    dataType: 'refObject',
    properties: {
      user: { ref: 'IUserModelResponse', required: true },
...
export function RegisterRoutes(app: express.Router) {
  ...
  app.post(
    ...
    function CreatePostController_handle(
      request: any,
      response: any,
      next: any
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      CreateSessionController.prototype.handle
    ),

    function CreateSessionController_handle(
      request: any,
      response: any,
      next: any
    ) {
  ...
  app.post(
    ...
    function CreateUserController_handle(
      request: any,
      response: any,
      next: any
    ) {
  ...
  app.delete(
    ...
    ...fetchMiddlewares<RequestHandler>(DeletePostController.prototype.handle),

    function DeletePostController_handle(
      request: any,
      response: any,
      next: any
    ) {
  ...
  app.get(
    '/api/v1/allPosts',
    ...fetchMiddlewares<RequestHandler>(ListAllPostsController),
    ...fetchMiddlewares<RequestHandler>(
      ListAllPostsController.prototype.handle
    ),

    function ListAllPostsController_handle(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller = new ListAllPostsController();
  ...
  app.get(
    '/api/v1/posts/:id',
    authenticateMiddleware([{ bearer_Token: [] }]),
    ...fetchMiddlewares<RequestHandler>(ListUserPostsController),
    ...fetchMiddlewares<RequestHandler>(
      ListUserPostsController.prototype.handle
    ),

    function ListUserPostsController_handle(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller = new ListUserPostsController();
  ...
  app.put(
    ...
    ...fetchMiddlewares<RequestHandler>(UpdatePostController.prototype.handle),

    function UpdatePostController_handle(
      request: any,
      response: any,
      next: any
    ) {
